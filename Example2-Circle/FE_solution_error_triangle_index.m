function [Relative_error,Absolute_error]=FE_solution_error_triangle_index(rho, accurate_function, t, P_partition, T_partition, basis_type, basis_index, derivative_degree_x, derivative_degree_y, Gauss_point_number)
...
Absolute_error = result1;
Relative_error=result1/result2;
